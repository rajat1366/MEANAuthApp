...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_6__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_8__guards_auth_guard__["a" /* AuthGuard */]] },
...
// module
exports.push([module.i, ".navbar-margin{\r\n    margin-top: 75px;\r\n}", ""]);
...
module.exports = "<div class=\"jumbotron text-center\">\n      <h1>MEAN Authentication App</h1>\n      <p class=\"lead\">Welcome to our custom MEAN authentication application</p>\n      <div>\n        <a class=\"btn btn-success\" routerLink=\"/register\">Register</a> <a class=\"btn btn-success\" routerLink=\"/login\">Login</a>\n      </div>\n</div>\n\n<div class=\"row\">\n    <div class=\"col-md-4\">\n        <div class=\"panel\">\n          <h3>Express Backend</h3>\n          <p>A rock Solid Node.js/Express server using Mongoose to organize models and query the database</p>\n        </div>\n    </div>\n    <div class=\"col-md-4\">\n      <div class=\"panel\">\n      <h3>Angular-CLI</h3>\n      <p>Angular-CLI to generate components, services and more. Local dev server and easy complilation</p>\n      </div>\n    </div>\n    <div class=\"col-md-4\">\n      <div class=\"panel\">\n      <h3>JWT Tokens</h3>\n      <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n      </div>\n    </div>\n\n</div>  "
...
var LoginComponent = (function () {
    function LoginComponent(_authService, _flashMessagesService, router, _validateService) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this._authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this._flashMessagesService.show("You are now logged In", { cssClass: 'alert-success', timeout: 5000 });
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_validate_service__["a" /* ValidateService */]) === "function" && _d || Object])
], LoginComponent);
...
var NavbarComponent = (function () {
    function NavbarComponent(_authService, _flashMessagesService, router) {
        this._authService = _authService;
        this._flashMessagesService = _flashMessagesService;
        this.router = router;
    }
...
var RegisterComponent = (function () {
    function RegisterComponent(_validateService, _flashMessagesService, _authService, router) {
        this._validateService = _validateService;
        this._flashMessagesService = _flashMessagesService;
        this._authService = _authService;
        this.router = router;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this._authService.registerUser(user).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                _this._flashMessagesService.show("You are now Registered and log in ", { cssClass: 'alert-success', timeout: 10000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this._flashMessagesService.show(data.message, { cssClass: 'alert-danger', timeout: 10000 });
